...
// 提供多种方法获取应用集合(com.netflix.discovery.shared.Applications) 和
// 应用实例信息集合( com.netflix.appinfo.InstanceInfo )。
// 提供方法获取本地客户端信息，例如，应用管理器( com.netflix.appinfo.ApplicationInfoManager )
